...
export const LiveCommentCarousel: React.FC<LiveCommentCarouselProps> = ({ scores }) => {
  ...
  return (
    <div className="h-[60px] mt-5 overflow-hidden bg-transparent w-full">
      {validScores.length > 0 && (
        ...
        >
          {validScores.map((score, index) => {
            ...
            return (
              <div key={score.id || index} className="h-[60px] flex flex-col justify-center w-full">
